        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a href="#maindata" role="tab" href="#maindata" class="nav-link active" data-toggle="tab">Основные данные</a>
                    </li>
                    <li class="nav-item">
                        <a href="#adddata" role="tab" href="#adddata" class="nav-link" data-toggle="tab">Доп. данные</a>
                    </li>
                </ul>
                <br>
